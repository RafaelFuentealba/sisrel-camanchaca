                                ...
                                <div class="dropdown-list-content dropdown-list-message">
                                    <a href="#" class="dropdown-item"> <span
                                            class="dropdown-item-avatar
                                                text-white">
                                            <img alt="image" src="{{ asset('public/assets/img/users/user-1.png') }}"
                                            ...
                                            <img alt="image" src="{{ asset('public/assets/img/users/user-2.png') }}"
                                                class="rounded-circle">
                                            ...
                                            class="dropdown-item-avatar text-white">
                                            <img alt="image" src="{{ asset('public/assets/img/users/user-5.png') }}"
                                                class="rounded-circle">
                                            ...
                                            class="dropdown-item-avatar text-white">
                                            <img alt="image" src="{{ asset('public/assets/img/users/user-4.png') }}"
                                                class="rounded-circle">
                                            ...
                                            class="dropdown-item-avatar text-white">
                                            <img alt="image" src="{{ asset('public/assets/img/users/user-3.png') }}"
                                                class="rounded-circle">
                                            ...
                                            class="dropdown-item-avatar text-white">
                                            <img alt="image"
                                                src="{{ asset('public/assets/img/users/user-2.png') }}"
                                                class="rounded-circle">
                                        </span> <span class="dropdown-item-desc"> <span class="message-user">Sarah
