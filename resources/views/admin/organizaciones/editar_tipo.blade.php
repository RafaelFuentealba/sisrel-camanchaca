            ...
            <div class="col-8 col-md-8 col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h4>Actualizar tipo de organización</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.actualizar.tiporg',$tiporg->tior_codigo) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre" name="nombre"
                                                value="{{$tiporg->tior_nombre}}" autocomplete="off">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label>Seleccione el estado del tipo de organización</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            </div>
