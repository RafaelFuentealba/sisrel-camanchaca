...
class AutenticationController extends Controller {
    ...
    public function validarIngreso(Request $request) {
        ...
        if (!$usuario) return redirect()->back()->with('errorRut', 'El usuario no tiene acceso al sistema con rol '.$rol.'.')->withInput();
    ...
    public function guardarRegistro(Request $request)
    {
        $request->validate(
            ...
            [
                ...
                'nombre.max' => 'El nombre ingresado supera el máximo de caracteres permitidos',
                'apellido.required' => 'El apellido es un parametro requerido',
                'apellido.max' => 'El apellido ingresado supera el máximo de caracteres permitidos',
                'email.requerid' => 'El email es un parametro requerido',
                'email.max' => 'El email ingresado supera el máximo de caracteres permitidos',
                'email_alt.max' => 'El email alternativo ingresado supera el máximo de caracteres permitidos',
                'clave.required' => 'La contraseña es requerida',
                'cargo.required' => 'Es requido asignar un cargo al usuario',
                'cargo.max' => 'El cargo supera la cantidad máxima de caracteres permitidos',
                'profesion.max' => 'La profesión supera la cantidad máxima de caracteres permitidos',
